...
export interface EvaluatorOptions<T extends XPathNode> {
	...
	/**
	 * The expression parser to use. The vendored bundle does NOT include the
	 * TreeSitter/WASM-based parser — callers MUST inject a pure-JS ExpressionParser
	 * instance here (implemented in Slice 2).
	 */
